...
public class Cores {
	...
	//Reset Color - tira a cor
		public static final String TEXT_RESET = "\u001B[0m";

		//Text Color - cada um representa uma cor/define a cor do texto
		...
		//Reset Text Underline - cor do underline
		...
		// Text Color High Intensity- cor com bastante luminosidade
		...
		// Text Color Bold High Intensity - com luz e negrito
		...
		// Background Color altera o backgroung
